...
updateEmployee(id : number,data: any): Observable<any[]> {
  ...
  return this.httpClient.put<any[]>(`${environment.apiUrl}/${environment.prefix}/employees/${id}`,{ employeeFirstName, "employeeLastName": employeeLasttName,"employeePhoneNumber" : employeePhone, "departmentId": department.id });
}
